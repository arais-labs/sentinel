"""Shared message/event datatypes used by providers and agent runtime."""
...
StopReason = Literal[
    "stop", "length", "tool_use", "error", "aborted", "timeout", "refusal", "pause_turn"
]
...
class AssistantMessage:
    ...
    # Opaque Responses items are replayed only by the originating provider.
    responses_output: list[dict[str, Any]] = field(default_factory=list)
    provider_usage: dict[str, Any] | None = None
    responses_context_reset: bool = False
...
class ReasoningConfig:
    ...
    max_tokens: int = 8192
    fast_mode: bool = False  # Opt-in premium processing; provider translates the wire format.
    ...
    override_fields: frozenset[str] = field(default_factory=frozenset)
