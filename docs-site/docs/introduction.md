...
Sentinel is an open source autonomous agent platform built by [ARAIS](https://arais.us). It combines a custom Python agent runtime, structured persistent memory, browser automation, a permissions and approval system, and a clean UI into one self hosted stack you can boot quickly.
