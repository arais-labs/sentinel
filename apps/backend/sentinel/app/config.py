...
class Settings(BaseSettings):
    ...
    primary_provider: str = "anthropic"  # "anthropic", "openai", or "gemini"
    ...
    tier_fast_gemini_model: str = "gemini-2.0-flash"
    ...
    tier_normal_gemini_model: str = "gemini-2.5-flash"
    ...
    tier_hard_gemini_model: str = "gemini-2.5-pro"
