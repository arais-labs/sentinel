...
Used by both built-in modules (code-defined) and custom modules (DB-defined).
"""
...
class ParamDefinition:
    """A parameter for an action (flat parameter format)."""
...
class ActionDefinition:
    ...
    code: str | None = None  # custom modules — Python executed in runtime
    handler: Any | None = None  # built-in modules — the actual async handler function
...
class ModuleDefinition:
    """A unified module definition — used by both built-in and custom modules."""
