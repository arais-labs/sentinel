...
_browser_pool: browser_pool_module.BrowserPool | None = None
...
def configure_runtime_services(
    *,
    browser_pool: browser_pool_module.BrowserPool | None = None,
...
def get_browser_pool() -> browser_pool_module.BrowserPool:
    global _browser_pool
    if _browser_pool is None:

        _browser_pool = browser_pool_module.BrowserPool()
