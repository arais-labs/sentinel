...
MODULE = ModuleDefinition(
    name="memory",
    label="Memory",
    description="Persistent knowledge shared across sessions in this instance. Search relevant prior context; store or update durable preferences, decisions, and verified discoveries. Avoid temporary task state and duplicate entries.",
    icon="brain",
    system=True,
    grouped_tool=True,
    actions=[
