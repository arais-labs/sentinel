...
class Trigger(Base):
    ...
    next_fire_at: Mapped[datetime | None] = mapped_column(UTCDateTime(), nullable=True, index=True)
...
class TriggerLog(Base):
    ...
    fired_at: Mapped[datetime] = mapped_column(UTCDateTime(), server_default=func.now())
