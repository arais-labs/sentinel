...
const api: DesktopApi = {
  ...
  openPaneWindow: request => ipcRenderer.invoke(IPC.openPaneWindow, request),
  dockPaneWindow: () => ipcRenderer.invoke(IPC.dockPaneWindow),
  onPaneWindowClosed: listener => subscribe(IPC.paneWindowClosed, listener),
