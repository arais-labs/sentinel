                  ...
                  <div className="relative before:absolute before:inset-0 before:ml-4 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-px before:bg-[color:var(--border-subtle)]">
                    {filteredEvents.map((event, idx) => {
                      ...
                      return (
                        ...
                        >
                          {/* Timeline Node */}
                          <div className={`flex items-center justify-center w-8 h-8 rounded-full border border-[color:var(--border-subtle)] bg-[color:var(--surface-0)] shrink-0 md:order-1 ${isRight ? 'md:-translate-x-1/2' : 'md:translate-x-1/2'} z-10 shadow-sm transition-transform group-hover:scale-110`}>
                          ...
                          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] cursor-pointer" onClick={handleCardClick}>
                            <div className="rounded-lg border border-[color:var(--border-subtle)] bg-[color:var(--surface-0)] hover:border-[color:var(--border-strong)] hover:shadow-md transition-all p-4">
                                ...
                                {isJson && isRecord(event.payload) ? (
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    {cardToolCalls.slice(0, 2).map((call, ci) => {
                                      ...
                                      return (
                                        <div key={ci} className="rounded border border-[color:var(--border-subtle)] p-2 space-y-1">
                                  ...
                                  <pre className="text-[10px] font-mono text-[color:var(--text-secondary)] bg-[color:var(--surface-1)] rounded p-2 overflow-hidden max-h-24 whitespace-pre-wrap break-all line-clamp-4">{event.summary}</pre>
                                ) : (
                  ...
                  {!loadingMessages && hasMore && (
                    <div className="pt-12 pb-8 flex justify-center">
                      <button
                        ...
                        className="px-6 py-2 rounded-full border border-[color:var(--border-subtle)] bg-[color:var(--surface-0)] text-[10px] font-bold uppercase tracking-widest text-[color:var(--text-muted)] hover:text-[color:var(--text-primary)] hover:border-[color:var(--border-strong)] transition-all shadow-sm flex items-center gap-2"
                      >
